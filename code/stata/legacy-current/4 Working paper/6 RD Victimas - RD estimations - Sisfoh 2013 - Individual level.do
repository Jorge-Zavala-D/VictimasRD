...
use "$input_dir\3 Coded\community_index_treated_sisfohpers_both.dta", clear
...
foreach y in $dep_ind {	
	...
	*RD not including covariates - Optimal Bandwidht selection
	local p=1
		...
		bwselect(msecomb2) kernel(triangular) p(1) masspoints(off)
...
*/
	...
	* NEW ESTIMATIONS (OLD + WITH SAN MARTIN)
	capture program drop rd_individuals2
	program define rd_individuals2
putexcel set "$output_dir\regressions\6 Working paper\Victimas RD - Outcomes at individual level.xlsx", sheet("Pooled ind - No baseline") modify
...
global	dep_ind jefe_hogar sexo gestante edad_0_5 /**
	...
	**/	edad_65_70 edad_70_mas edad_6_12_noescuela nivel_educ2 nivel_educ3_ninguno prog_vasoleche 		/**
	**/	prog_comedorpop prog_desalm prog_papyap prog_canastaalim prog_juntos 	/**
	**/	prog_pension65 prog_otro2 prog_ninguno num_prog_ind tiene_prog  trabaja_agropec seg_essalud seg_privado 	/**
	**/	seg_otro2 seg_ninguno num_seguro_ind tiene_seguro ocupado trabaja_agricola trabaja_pecuaria 			/**
	...
	**/	ocupacion_estud ocupacion_otro2 

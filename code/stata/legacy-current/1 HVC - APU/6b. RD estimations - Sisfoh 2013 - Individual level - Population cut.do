...
*---------------------------*
	...
	2.	Define program
		2.1.	Program for individuals in CCPP with population below median
		2.2.	Program for individuals in CCPP with population above median
...
global	controls urb_rur altura_coded distancia_capital prop_a13 ///
		edad poverty2007_caracthh poverty2007_servpub poverty2007_demogra 		///
		sisf_numperso

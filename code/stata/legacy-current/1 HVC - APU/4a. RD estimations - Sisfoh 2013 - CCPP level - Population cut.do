...
*---------------------------*
	...
	2.	Define program
		2.1.	Program for CCPP with population below median
		2.2.	Program for CCPP with population above median
...
*	For low population communities

use "$a\2 data\community_index_treated_sisfohccpp.dta", clear
gen a=1
egen	pob_ccpp_p50 = median(pob_ccpp_2007) if dpto=="HUANCAVELICA" | dpto=="APURIMAC" 
...
*	For high population communities

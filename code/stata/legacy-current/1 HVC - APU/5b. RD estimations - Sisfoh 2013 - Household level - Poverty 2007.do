...
*---------------------------*
	...
	2.	Define program
		2.1.	Program for household in CCPP with Poverty Index below average
		2.2.	Program for household in CCPP with Poverty Index above average
...
*---------------------------------------------------*
*		Program for low populattion communities		*
*---------------------------------------------------*		
...
*	For Households in low poverty communities
use "$a\2 data\community_index_treated_sisfohhogpers.dta", clear

gen	poverty2007_p50 = 0.41 if dpto=="HUANCAVELICA" | dpto=="APURIMAC" 
...
global	dep_hog  sisf_piso_parquet 		/**
...
*	For Households in high poverty communities
use "$a\2 data\community_index_treated_sisfohhogpers.dta", clear

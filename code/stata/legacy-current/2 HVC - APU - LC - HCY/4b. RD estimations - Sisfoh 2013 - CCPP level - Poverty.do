...
putexcel set "$a\3 output\regressions\2 Huancavelica-Apurimac-La Convencion-Huancayo\$table.xls", sheet("Low poverty CCPP") modify
	putexcel C3 = ("$table")
	sleep 3500
...
*---------------------------------------------------*
*		Program for High poverty communities		*
*---------------------------------------------------*		
		
	capture program drop rd_ccpp_highpoverty
	program define rd_ccpp_highpoverty
putexcel set "$a\3 output\regressions\2 Huancavelica-Apurimac-La Convencion-Huancayo\$table.xls", sheet("High poverty CCPP") modify
	putexcel C3 = ("$table")
	sleep 3500
	putexcel D5 = ("RD no/covs. - optimal BW")
	sleep 3500
...
egen	poverty2007_p50 = median(poverty2007) if dpto=="HUANCAVELICA" | dpto=="APURIMAC" | prov=="LA CONVENCION" | prov=="HUANCAYO"
keep if poverty2007>poverty2007_p50 & poverty2007_p50!=.
	...
	global	dep_ccpp prop_pared_ladrillo prop_pared_piedra prop_pared_adobe		/**
		...
		**/		prop_asset_telefonofijo prop_asset_lavadora 	/**
	...
	global	dep_ccpp_2007 prop_pared_ladrillo2007 prop_pared_piedra2007 prop_pared_adobe2007	/**
		...
		**/		prop_asset_telefonofijo2007 prop_asset_lavadora2007 	/**

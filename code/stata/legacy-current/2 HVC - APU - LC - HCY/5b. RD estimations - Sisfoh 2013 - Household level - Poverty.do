...
use "$a\2 data\3 Coded\community_index_treated_sisfohhogpers.dta", clear
...
*-----------------------------------*
*		Program for low poverty		*
*-----------------------------------*	
		
	capture program drop rd_household_lowpoverty
	program define rd_household_lowpoverty

putexcel set "$a\3 output\regressions\2 Huancavelica-Apurimac-La Convencion-Huancayo\$table.xls", sheet("Low poverty") modify
	putexcel C3 = ("$table")
	sleep 3500
...
*-----------------------------------*
*		Program for high poverty		*
*-----------------------------------*	
		
	capture program drop rd_household_highpoverty
	program define rd_household_highpoverty

putexcel set "$a\3 output\regressions\2 Huancavelica-Apurimac-La Convencion-Huancayo\$table.xls", sheet("High poverty") modify
	putexcel C3 = ("$table")
	sleep 3500
	putexcel D5 = ("RD no/covs. - optimal BW")
	sleep 3500
...
gen	poverty2007_p50 = .4301534 if dpto=="HUANCAVELICA" | dpto=="APURIMAC" | prov=="LA CONVENCION" | prov=="HUANCAYO"
keep if poverty2007>poverty2007_p50 & poverty2007_p50!=.

global	table "\Sisfoh 2013 outcomes at Household level - Heterogeneous Effects - Poverty"
...
global	dep_hog sisf_pared_ladrillo sisf_pared_piedra sisf_pared_adobe 			/**
	...
	**/		ratio_trabaja_agricola trabaja_pecuaria_1 ratio_trabaja_pecuaria 	/**
	**/		trabaja_forestal_1 ratio_trabaja_forestal 		/**

...
*---------------------------------------*
*		Program for low population		*
*---------------------------------------*
	
	capture program drop rd_individuals_lowpop
	program define rd_individuals_lowpop
...
*---------------------------------------*
*		Program for high population		*
*---------------------------------------*
	
	capture program drop rd_individuals_highpop
	program define rd_individuals_highpop
...
keep if pob_ccpp_2007<=pob_ccpp_p50

global table "\Sisfoh 2013 outcomes at Individual level - Heterogeneous Effects - Population"
...
global table "\Sisfoh 2013 outcomes at Individual level - Heterogeneous Effects - Population"
global	dep_ind nivel_educ3_ninguno nivel_educ3_primaria /**
	**/	nivel_educ3_secundaria nivel_educ3_superior analfab edad_6_12_noescuela /**
	**/	gestante jefe_hogar ocupado trabaja_agricola trabaja_pecuaria 			/**
	**/ trabaja_minera trabaja_artesanal trabaja_comercial trabaja_servicios 	/**
	**/	trabaja_otro trabaja_gobierno trabaja_otro2 ocupacion_dep 				/**

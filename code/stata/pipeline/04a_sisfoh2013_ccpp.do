/*
Project: Victimas RD
Purpose: Estimate 2013 CCPP reduced-form and fuzzy-RD effects
Unit:    RUV centro poblado
Input:   11_community_registry_sisfoh_2013.dta (Dropbox Coded)
...
capture log close victimasrd_rd_2013_ccpp
log using "${logs_root}/rd_2013_ccpp_${rd_run_id}.smcl", ///
    name(victimasrd_rd_2013_ccpp) replace
...
local required_vars ///
    ...
    ${rd_treatment_2013} sisfoh2013_linked ///
    sisfoh2013_population sisfoh2013_households ///
...
assert inlist(${rd_treatment_2013}, 0, 1) if !missing(${rd_treatment_2013})
...
generate byte rd_sisfoh_sample = ///
    rd_bc_design & sisfoh2013_linked == 1
...
generate byte rd_primary_sample = ///
    rd_sisfoh_sample & primary_missing == 0

quietly count if rd_sisfoh_sample
assert r(N) == 487
...
preserve
import delimited using "${rd_outcome_registry}", ///
...
quietly rdrobust ///
    ${rd_treatment_2013} ${rd_running} if rd_bc_design, ///
...
_vrd_post_outcome_rd, ///
    ...
    outcomeid("D01") ///
    outlabel("Treatment through 2012: full B/C design universe") ///
...
_vrd_post_outcome_rd, ///
    ...
    outvar(${rd_treatment_2013}) ///
    outcomeid("D02") ///
    outlabel("Treatment through 2012: linked primary sample") ///
    family("design") tier("design") multiplicity("design") ///
...
_vrd_post_outcome_rd, ///
    ...
    outvar(${rd_treatment_2013}) ///
    outcomeid("D03") ///
    outlabel("Treatment through 2012: MSE selector") ///
    family("design") tier("design") multiplicity("design") ///
...
forvalues outcome_index = 1/`outcome_count' {
    ...
    local outcome_sample "rd_sisfoh_sample"
...
file write `contract_file' ///
    `""selector_h","`selected_h'","validated","MSE bandwidth selected from treat_12 in the B/C design universe""' _n
file write `contract_file' ///
    `""selector_b","`selected_b'","validated","Bias bandwidth selected from treat_12 in the B/C design universe""' _n
file write `contract_file' ///
...
file write `main_table' "\caption{Collective reparations and registered 2013 CCPP outcomes}" _n
file write `main_table' "\label{tab:rd_outcomes_main_2013_ccpp}" _n
...
file write `secondary_table' "\caption{Secondary and exploratory 2013 CCPP fuzzy-RD outcomes}" _n
file write `secondary_table' "\label{tab:rd_outcomes_secondary_2013_ccpp} \\" _n
...
file write `robustness_table' "\label{tab:rd_outcomes_robustness_2013_ccpp} \\" _n
...
program define _vrd_make_outcome_rdplot
    ...
    twoway ///
        ...
        note( ///
            "Notes: Unit is an RUV centro poblado in the selected B/C geography; SISFOH panels use linked communities." ///
...
_vrd_make_outcome_rdplot, ///
    ...
    figure("${rd_figure_dir}/fig_rd_outcomes_01_first_stage_2012.png") ///
...
forvalues outcome_index = 1/8 {
    ...
    local figure_number = `outcome_index' + 9
...
graph combine ///
    ...
    rows(3) imargin(tiny) ///
    title("Treatment assignment and primary 2013 CCPP outcomes", ///
        size(medsmall) color(black)) ///
    subtitle("Common B-C design window; reduced-form local-linear fits", ///
        size(small) color(gs5)) ///
    note( ///
        "Notes: Unit is a SISFOH-linked RUV centro poblado in the selected B/C geography." ///
...
twoway ///
    ...
    xtitle("Bias-corrected fuzzy-RD effect (control-side SD units)", ///
        size(small)) ///
    ytitle("") ///
    title("Standardized effects on primary 2013 CCPP outcomes", ///
        size(medium) color(black)) ///
    ...
    note( ///
        ...
        "The local first stage is below the conservative F >= 20 gate." ///
...
twoway ///
    ...
    note( ///
        ...
        "No bandwidth is selected by the magnitude or significance of an outcome estimate. Sources: RUV, CMAN, and SISFOH 2012--2013.", ///
        size(tiny) color(gs5) span) ///
    xsize(10) ysize(7) ///
    graphregion(color(white)) plotregion(color(white))
...
local output_paths ///
    output/tables/rd_outcomes/rd_2013_ccpp_results.csv ///
    output/tables/rd_outcomes/rd_2013_ccpp_analysis_contract.csv ///
    output/tables/rd_outcomes/tab_rd_outcomes_01_registry.tex ///
    output/tables/rd_outcomes/tab_rd_outcomes_02_first_stage.tex ///
    output/tables/rd_outcomes/tab_rd_outcomes_03_main_2013_ccpp.tex ///
    output/tables/rd_outcomes/tab_rd_outcomes_04_secondary_2013_ccpp.tex ///
    output/tables/rd_outcomes/tab_rd_outcomes_05_robustness_2013_ccpp.tex ///
    output/figures/rd_outcomes/fig_rd_outcomes_01_first_stage_2012.png ///
    output/figures/rd_outcomes/fig_rd_outcomes_02_primary_panels_2013_ccpp.png ///
    output/figures/rd_outcomes/fig_rd_outcomes_03_late_forest_2013_ccpp.png ///
    output/figures/rd_outcomes/fig_rd_outcomes_04_bandwidth_sensitivity_2013_ccpp.png ///
    output/figures/rd_outcomes/fig_rd_outcomes_10_log_population.png ///
    output/figures/rd_outcomes/fig_rd_outcomes_11_log_households.png ///
    output/figures/rd_outcomes/fig_rd_outcomes_12_age_15_29.png ///
    output/figures/rd_outcomes/fig_rd_outcomes_13_any_program.png ///
    output/figures/rd_outcomes/fig_rd_outcomes_14_wellbeing_core.png ///
    output/figures/rd_outcomes/fig_rd_outcomes_15_nbi_any.png ///
    output/figures/rd_outcomes/fig_rd_outcomes_16_labor_force_participation.png ///
    output/figures/rd_outcomes/fig_rd_outcomes_17_secondary_education.png

tempname manifest_file
file open `manifest_file' using "${rd_manifest}", ///
    write replace text
...
foreach output_path of local output_paths {
    ...
    if _rc {
        display as error "Expected 2013 CCPP output was not created:"
    ...
    file write `manifest_file' ///
        `""`output_path'","`artifact_type'","11_community_registry_sisfoh_2013.dta","`input_datasignature'","code/stata/pipeline/04a_sisfoh2013_ccpp.do","${rd_run_id}","`output_checksum'","generated_unreviewed""' _n
}
...
display as result "SISFOH 2013 CCPP outcome module completed."

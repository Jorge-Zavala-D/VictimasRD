/*
Project: Victimas RD
Purpose: Estimate prespecified Census 2017 individual RD heterogeneity
Unit:    INEI-assisted Census source-cohort person linked to an RUV CCPP
...
capture log close victimasrd_hte_2017_individual
log using "${logs_root}/hte_2017_individual_${hte_run_id}.smcl", ///
    name(victimasrd_hte_2017_individual) replace
...
use "${hte_input_2017_individual}", clear
...
local required_vars ///
    ...
    ruv_id ubigeo_dist sample_main_rd victimization_level_source ///
    ${hte_running} ${hte_treatment_2017} ///
    census2017_linked age_2017 female_2017 ///
    age_15_29_2017 moved_ccpp_2013_2017 ///
...
assert inlist(census2017_linked, 0, 1) if !missing(census2017_linked)

local primary_outcomes ///
    female_2017 ///
    age_15_29_2017 ///
    moved_ccpp_2013_2017 ///
    secondaryplus_age14_2017 ///
    employed_age14_2017 ///
    insurance_any_2017 ///
    disability_any_2017 ///
    wellbeing_core_2017
...
global hte_outcome_registry_level   "${hte_outcomes_17_ind}"
...
global hte_input_basename           "12_census_2017_individual_analysis.dta"
global hte_input_datasignature      "`input_datasignature'"
global hte_module_current           "code/stata/pipeline/05f_census2017_individual_heterogeneity.do"
...
log close victimasrd_hte_2017_individual

...
local module_2017_individual ///
    "${pipeline_root}/05f_census2017_individual_heterogeneity.do"
...
global hte_input_2017_individual "`input_2017_individual'"
...
global hte_outcomes_17_ind  "`registry_17_ind'"
...
global hte_manifest_2017_individual ///
...
display as result "Starting Census 2017 individual heterogeneity analysis."
capture estimates clear
capture ereturn clear
capture matrix drop _all
do "`module_2017_individual'"
if _rc {
    display as error "Census 2017 individual heterogeneity module failed."
    exit _rc
}
...
display as result "Completed all SISFOH 2013 and Census 2017 heterogeneity modules."
